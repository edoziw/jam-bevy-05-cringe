...
fn enter_credits(mut commands: Commands) {
    commands
        ...
        .with_children(|children| {
            ...
            children.label("Kipcringe - LRL");

            children.header("Special Thanks");
            children.label("LRL");
            ...
            children.label("Codon Chart - public domain https://commons.wikimedia.org/wiki/File:Aminoacids_table.svg");
